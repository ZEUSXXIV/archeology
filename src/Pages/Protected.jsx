...
export default function Protected(){
    ...
    const [isModalOpen, setIsModalOpen] = useState(false); 
     ...
     return(
        ...
        <div style={{ background:"#c6cdbc"}}>
        {/* <h1 style={{textAlign:'center'}}>Protected Monuments</h1> */}
        <Typography style={{fontWeight:'600', fontSize:'36px', textAlign:'center',paddingTop:'2%', paddingBottom:'2%'}} >Protected Monuments</Typography>
        ...
        <Modal open={isModalOpen} onCancel={()=> setIsModalOpen(false)} footer={null} closable={false}>
      ...
      <h3 className={`${Styles.title}`}>{activeItem?.Title}</h3>
        ...
        <div>
         {/* <Typography maxLength={5}>{desp}</Typography> */}
          <div className={`${Styles.monu_para}`}>{activeItem?.Description}</div>
